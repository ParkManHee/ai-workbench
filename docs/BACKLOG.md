...
## Tier 1 — "폰 감독 루프" 완성 (진행 중)

- [ ] **질문 대기(🔴) 전용 푸시** — 완료가 아니라 "답 필요해서 멈춤"을 알림으로 구분 (S~M)
- [ ] **hung run 자동 타임아웃** — 멈춘 claude가 락을 무기한 잡는 문제. 초과 시 cancel + .done (M)
- [ ] **실행 중 후속 지시(턴 큐잉)** — running 중 409 대신 큐 적재, 턴 종료 시 자동 resume 전달 (M)
- [ ] **어디서든 취소** — 앱 재시작·다른 기기에서도 활성 run에 attach해 취소 (M)
- [ ] **툴 권한 원격 승인/거부** — Bash/Edit 허가를 폰에서 버튼으로. 공식 RC·Happy·Omnara 보유, 무인 실행이 멈추는 최대 원인 (L)
